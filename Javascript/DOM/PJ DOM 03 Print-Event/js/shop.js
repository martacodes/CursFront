...
const templateCard = document.getElementById('template-card').content //el content es per seleccionar el contingut.
const fragment = document.createDocumentFragment() //temporal, serveix per més d'una funció.
